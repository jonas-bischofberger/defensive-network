...
for file_name in file_names:
    full_path = "player_matchsums/10/" + file_name
    # full_path = "involvement/10/" + file_name
    if "fifa-men-s-world-cup-2022-1-st-senegal-netherlands" not in file_name:
    ...
    file_name = "player"+ file_name .replace(".parquet", ".csv")
