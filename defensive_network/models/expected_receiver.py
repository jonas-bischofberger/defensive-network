...
def get_expected_receiver(
    ...
    for pass_index, p4ss in df_passes_unsuccessful.iterrows():
        ...
        distance_to_pass_endpoint_col, defender_angle_col, angle_to_pass_lane_col = get_unused_column_name(df_tracking_frame_attackers.columns, "distance_to_pass_endpoint"), get_unused_column_name(df_tracking_frame_attackers.columns, "defender_angle"), get_unused_column_name(df_tracking_frame_attackers.columns, "angle_to_pass_lane")
        ...
        expected_receiver_score_distance_col, expected_receiver_score_angle_col, expected_receiver_score_col = get_unused_column_name(df_tracking_frame_attackers.columns, "expected_receiver_score_distance"), get_unused_column_name(df_tracking_frame_attackers.columns, "expected_receiver_score_angle"), get_unused_column_name(df_tracking_frame_attackers.columns, "expected_receiver_score")
